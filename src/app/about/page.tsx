...
export default function AboutPage() {
  ...
  const values = [
    ...
    { emoji: '🤖', title: language === 'ru' ? 'Инновации' : language === 'kg' ? 'Инновациялар' : 'Innovations', desc: language === 'ru' ? 'Виртуальная примерочная и ИИ-подбор оправ' : language === 'kg' ? 'Виртуалдык кийип көрүү жана ИИ менен алкак тандоо' : 'Virtual try-on and AI frame matching' },
